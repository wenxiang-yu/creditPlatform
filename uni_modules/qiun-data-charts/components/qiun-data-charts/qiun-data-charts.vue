...
export default {
  ...
  methods: {
    ...
    newEChart(){
      ...
      //     cfe.instance[cid].resize()
      //   console.log(cfe.instance[cid],'---------------');
      // })
        //ontap开启后才触发click事件
    ...
    updataEChart(cid,option){
      // console.log(cid=='"mapcharts"');
      // if(cid==='"mapcharts"'){
      //   this.$emit("mapcharts",option)
      // }
      ...
      cfe.instance[cid].setOption(option, option.notMerge,true)
